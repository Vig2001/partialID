...
# I think that the optimal weight should approximate the ideal case:
# Intersect every bootstrap draw of ID sets and then take the CI of the resulting draws.
### -----------------

# Another method to consider is to intersect the two CIs directly
# Not valid at the same level - might need to widen the individual CIs
# To account for Bonferroni correction
...
# Now we can compute the confidence intervals for the intersection and convex combination
